...
const createAcademicDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield services_1.AcademicDepartmentServices.getAllAcademicDepartmentFromDB(req.body);
    res.status(200).json({
        success: true,
...
const getAllAcademicDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield services_1.AcademicDepartmentServices.getAllAcademicDepartmentFromDB(req.query);
    res.status(200).json({
        success: true,
...
const deleteAcademicDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield services_1.AcademicDepartmentServices.deleteAcademicDepartmentFromDB(id);
    res.status(200).json({
        success: true,
        message: "get all AcademicDepartment successfully",
        data: result,
