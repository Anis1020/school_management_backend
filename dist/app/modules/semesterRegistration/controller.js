...
const getAllSemesterRegistration = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield services_1.SemesterRegistrationServices.getAllSemesterRegistrationFromDB(req.query);
    res.status(200).json({
        success: true,
...
const deleteSemesterRegistration = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield services_1.SemesterRegistrationServices.deleteSemesterRegistrationFromDB(id);
    res.status(200).json({
        success: true,
        message: "get all SemesterRegistration successfully",
        data: result,
