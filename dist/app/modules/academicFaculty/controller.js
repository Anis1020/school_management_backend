...
const createAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield services_1.AcademicFacultyServices.getAllAcademicFacultyFromDB(req.body);
    res.status(200).json({
        success: true,
...
const getAllAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield services_1.AcademicFacultyServices.getAllAcademicFacultyFromDB(req.query);
    res.status(200).json({
        success: true,
...
const deleteAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield services_1.AcademicFacultyServices.deleteAcademicFacultyFromDB(id);
    res.status(200).json({
        success: true,
        message: "get all AcademicFaculty successfully",
        data: result,
